	...
	return function n(s) {
		...
		for (let { target: r } = s; r && r !== this; r = r.parentNode)
			for (let a = o.length; a--; )
				if (o[a] === r)
					return (
						(s.delegateTarget = r), n.oneOff && EventHandler.off(e, s.type, t, i), i.apply(r, [s])
					)
		return null
	}
}
...
class Collapse extends BaseComponent {
	...
	_getConfig(e) {
		return (
			((e = { ...Default$9, ...Manipulator.getDataAttributes(this._element), ...e }).toggle =
				Boolean(e.toggle)),
...
class Backdrop {
	...
	_getConfig(e) {
		return (
			((e = { ...Default$7, ...('object' == typeof e ? e : {}) }).rootElement = getElement(
				e.rootElement
			)),
...
class Tooltip extends BaseComponent {
	...
	show() {
		...
		Data.set(n, this.constructor.DATA_KEY, this),
			...
			this._popper
				? this._popper.update()
				: (this._popper = Popper.createPopper(this._element, n, this._getPopperConfig(r))),
