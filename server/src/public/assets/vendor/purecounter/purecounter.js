			...
			(i = [
						...
						return (
							i.forEach(function (e) {
								var t = e.name.replace('data-purecounter-', '').toLowerCase(),
									r =
										'duration' == t ? parseInt(1e3 * n.parseValue(e.value)) : n.parseValue(e.value)
								o[t] = r
							}),
							Object.assign(a, o)
						)
				...
				},
				{
					...
					value: function (e, t) {
						...
						return (
							(e = t.currency ? this.convertToCurrencySystem(e, t) : parseFloat(e)),
				...
				},
				{
					...
					value: function (e) {
						for (
							var t = e.offsetTop, r = e.offsetLeft, n = e.offsetWidth, a = e.offsetHeight;
							e.offsetParent;
